  ...
  useEffect(() => {
    ...
    function getCanvasPreset(width: number, height: number): CanvasPreset {
      ...
      if (width <= 380) {
        return {
          name: "mobile-xs",
          maxTextWidthRatio: 0.90,
          maxTextHeightRatio: shortViewport ? 0.38 : 0.46,
          fontRatio: 0.124,
          minFont: 34,
          maxFont: 58,
          lineHeightRatio: 0.84,
          centerY: shortViewport ? 0.43 : 0.45,
          gap: 4.1,
          scatter: 46,
          particleMin: 0.56,
          particleMax: 1.22,
      ...
      if (width <= 520) {
        return {
          ...
          maxTextHeightRatio: shortViewport ? 0.43 : 0.52,
          fontRatio: 0.145,
          minFont: 44,
          maxFont: 82,
          lineHeightRatio: 0.82,
          centerY: shortViewport ? 0.42 : 0.44,
          gap: 3.8,
          scatter: 60,
          particleMin: 0.62,
          particleMax: 1.36,
